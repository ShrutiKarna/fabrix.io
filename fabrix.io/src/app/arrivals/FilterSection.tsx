  ...
  return (
    <div className='border-2 rounded-lg w-[350px] p-4'>
            ...
            <div className='space-y-4'>
                {
                    Dress.map((element)=>(
                        <div key={element} className='flex justify-between'>
                            <p className='text-textGray'>{element}</p>
            ...
            <div className='space-y-2'>
                <div className='flex justify-between items-center'>
                    <h2 className='text-xl font-semibold text-primary'>Price</h2>
                ...
                <div className="relative h-10">
                    ...
                    {/* Black active range */}
                    <div className="absolute top-1/2 left-[20%] right-[20%] h-2 bg-primary rounded-full -translate-y-1/2" />

                    {/* Left black circle */}
                    <div className="absolute top-1/2 left-[20%] w-5 h-5 bg-primary rounded-full -translate-x-1/2 -translate-y-1/2" />
            ...
            <div className='space-y-2'>
                <div className='flex justify-between items-center'>
                    <h2 className='text-xl font-semibold text-primary'>Color</h2>
                    <Image src={upArrow} alt="Filter Icon"/>
                </div>
            ...
            <div className='space-y-2'>
                <div className='flex justify-between items-center'>
                    <h2 className='text-xl font-semibold text-primary'>Size</h2>
                    <Image src={upArrow} alt="Filter Icon"/>
                </div>
                <div className="grid grid-cols-3 gap-4">
                    {
                        ['XX-Small','X-small','Small','Medium','Large','X-Large','XX-Large','3X-Large','4X-Large'].map((text,indx)=>(
                            <Button variant="outline" className='rounded-full bg-secondary hover:bg-primary hover:text-white' key={indx}>{text}</Button> 
                        ))
                    }
            ...
            <div className='space-y-5'>
                <div className='flex justify-between items-center'>
                    <h2 className='text-xl font-semibold text-primary'>Dress Style</h2>
                    <Image src={upArrow} alt="Filter Icon"/>
                </div>
