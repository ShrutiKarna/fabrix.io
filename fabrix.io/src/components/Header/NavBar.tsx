...
const NavBar = () => {
  return (
    <nav className='w-[400px] '>
      <ul className='flex items-center gap-6 list-none text-textGray  font-medium'>
        {navBarData.map((item) => (
          <li key={item.id}>
            ...
            {item.submenu ? (
              <DropdownMenu>
                ...
                <DropdownMenuContent align='start' className='bg-white shadow-md border border-gray-200'>
